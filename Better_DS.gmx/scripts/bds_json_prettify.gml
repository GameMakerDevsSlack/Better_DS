///bds_json_prettify( json string, [indent size], [newline character], [map spacing] )
//
...
//
// With thanks to salvakiya and yal.cc
...
repeat( string_length( _json_string ) ) {
    ...
    if ( _in_string ) {
        ...
        if ( _ord < 45 ) or ( _ord == 47 ) or ( _ord > 57 ) {
            ...
            if ( _number_string_dot >= _number_string_last_sig - 2 ) _number_string_last_sig = _number_string_dot - 1;
